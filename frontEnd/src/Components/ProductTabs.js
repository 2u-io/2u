...
import {Button, Tabs,Tab, Table} from 'react-materialize';
        ...
        <div className=' row Product' >
            <Tabs className="tab-demo z-depth-1">
                ...
                <Tab title="Cajas y Bolsas de regalo">
                    <div>
                        ...
                        <div class="card col s12 m6 l4">
                            ...
                            <img class="activator box-image" src={bolsa1} alt='bolsa'/>
                            </div>
                        ...
                        <div class="card col s12 m6 l4">
                            <div class="card-image waves-effect waves-block waves-light">
                            <img class="activator box-image" src={bolsa2} alt='bolsa2'/>
                            </div>
                            <div class="card-content">
                        ...
                        <div class="card col s12 m6 l4">
                            <div class="card-image waves-effect waves-block waves-light">
                            <img class="activator box-image" src={bolsa3} alt='bolsa3'/>
                            </div>
                            <div class="card-content">
                ...
                <div>
                        ...
                        <div class="card col s12 m6 l4">
                            <div class="card-image waves-effect waves-block waves-light">
                            <img class="activator box-image" src={envoltura1} alt='envoltura'/>
                            </div>
                            <div class="card-content">
                        ...
                        <div class="card col s12 m6 l4">
                            <div class="card-image waves-effect waves-block waves-light">
                            <img class="activator box-image" src={envoltura2} alt='envoltura2'/>
                            </div>
                            <div class="card-content">
                        ...
                        <div class="card col s12 m6 l4">
                            <div class="card-image waves-effect waves-block waves-light">
                            <img class="activator box-image" src={envoltura3} alt='envoltura3'/>
                            </div>
                            <div class="card-content">
                ...
                <Tab title="Moños">
                    <div>
                        ...
                        <div class="card col s12 m6 l4">
                            <div class="card-image waves-effect waves-block waves-light">
                            <img class="activator box-image" src={moño1} alt='moño1'/>
                            </div>
                            <div class="card-content">
                        ...
                        <div class="card col s12 m6 l4">
                            <div class="card-image waves-effect waves-block waves-light">
                            <img class="activator box-image" src={moño2} alt='moño2'/>
                            </div>
                            <div class="card-content">
                        ...
                        <div class="card col s12 m6 l4">
                            <div class="card-image waves-effect waves-block waves-light">
                            <img class="activator box-image" src={moño3} alt='moño3'/>
                            </div>
                            <div class="card-content">
